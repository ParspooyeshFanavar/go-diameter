...
Package [go-diameter](http://godoc.org/bitbucket.parspooyesh.com/ibscgw/go-diameter) is an
...
[![GoDoc](https://godoc.org/bitbucket.parspooyesh.com/ibscgw/go-diameter?status.svg)](https://godoc.org/bitbucket.parspooyesh.com/ibscgw/go-diameter)
...
See the API documentation at http://godoc.org/bitbucket.parspooyesh.com/ibscgw/go-diameter
...
go run bitbucket.parspooyesh.com/ibscgw/go-diameter/v4/examples/server
go run bitbucket.parspooyesh.com/ibscgw/go-diameter/v4/examples/client -hello
```

Without modules, use standard procedure:

```
go get bitbucket.parspooyesh.com/ibscgw/go-diameter/examples/...
go run bitbucket.parspooyesh.com/ibscgw/go-diameter/examples/server
go run bitbucket.parspooyesh.com/ibscgw/go-diameter/examples/client -hello
```
