...
[![Go Report Card](https://goreportcard.com/badge/github.com/ParspooyeshFanavar/go-diameter)](https://goreportcard.com/report/github.com/ParspooyeshFanavar/go-diameter)
[![Test Status](https://github.com/ParspooyeshFanavar/go-diameter/actions/workflows/test.yaml/badge.svg)](https://github.com/ParspooyeshFanavar/go-diameter/actions/workflows/test.yaml)
[![Go Reference](https://pkg.go.dev/badge/github.com/ParspooyeshFanavar/go-diameter/v4.svg)](https://pkg.go.dev/github.com/ParspooyeshFanavar/go-diameter/v4)
[![Latest](https://img.shields.io/github/v/tag/fiorix/go-diameter.svg?sort=semver&style=flat-square&label=latest)](https://github.com/ParspooyeshFanavar/go-diameter/tags)

Package [go-diameter](https://pkg.go.dev/github.com/ParspooyeshFanavar/go-diameter/v4) is an
...
See the API documentation at https://pkg.go.dev/github.com/ParspooyeshFanavar/go-diameter/v4
...
go run github.com/ParspooyeshFanavar/go-diameter/v4/examples/server
go run github.com/ParspooyeshFanavar/go-diameter/v4/examples/client -hello
```

Without modules, use standard procedure:

```
go get github.com/ParspooyeshFanavar/go-diameter/examples/...
go run github.com/ParspooyeshFanavar/go-diameter/examples/server
go run github.com/ParspooyeshFanavar/go-diameter/examples/client -hello
```
